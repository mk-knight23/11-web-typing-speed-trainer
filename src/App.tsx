    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 selection:bg-yellow-500/30">
            <div className="w-full max-w-4xl space-y-20">
                ...
                {/* Word Display */}
                <div className="relative group p-8 rounded-3xl bg-zinc-800/20 border border-zinc-800/50 backdrop-blur-sm shadow-2xl">
                    <div
                    ...
                    <AnimatePresence>
                        {endTime && (
                            ...
                            >
                                ...
                                <h2 className="text-4xl font-black text-white mb-2 uppercase tracking-tight">Test Complete!</h2>
                                <p className="text-zinc-400 mb-8 font-medium">You typed at {currentWpm} WPM with {accuracy}% accuracy.</p>
                                <button
                                    onClick={resetTest}
                ...
                <div className="flex justify-between items-center text-zinc-600 px-4">
                    ...
                    <div className="flex items-center gap-6">
                        <button className="hover:text-zinc-400 transition-colors"><History className="w-5 h-5" /></button>
                        <button className="hover:text-zinc-400 transition-colors text-yellow-500/50"><RotateCcw className="w-5 h-5" onClick={resetTest} /></button>
                    </div>
                </div>
...
function Stat({ label, value, icon, color }: { label: string, value: any, icon: any, color: string }) {
    return (
